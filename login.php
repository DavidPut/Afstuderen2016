            ...
            <div class="row">
              <div class="col-md-4 col-xs-12 col-md-offset-4">
                <div class="input-group">
                  ...
                  <input type="email" name="mail" class="form-control" placeholder="uw e-mailadres" <?php if($_SESSION['Callback'] == true){echo 'value="'.$_POST['BVPaddSummary'].'"';}?> aria-describedby="basic-addon1" autofocus>
                </div>
              </div>
            </div>
