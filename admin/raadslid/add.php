      ...
      <div class="page-header">
        <div class="pull-left">
          <h3>Besluitvorming <span class="label label-primary"><i class="fa fa-pencil small-icon" aria-hidden="true"></i></span>
            ...
            <a class="btn btn-default" href="https://twitter.com/home?status=http%3A//gemeentedossier.nl/dossier.php?id=<?php echo $_GET['id']; ?>%20Staat%20belangrijk%20nieuws%20in%20van%20de%20besluitvorming%20van%20de%20gemeente.%20" target="_blank">twitter delen</a>
          </h3>
        </div>
