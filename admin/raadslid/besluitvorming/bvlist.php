        ...
        <td>
          <p class='text-right'>";
            ...
            if ($db_getBVOpinionList_info){
              ...
              echo "<a class=\"btn btn-success\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Toevoegen\" href=\"admin/raadslid/besluitvorming/bdadd.php?id=".$db_getBVList_info_item['id']."\"><i class=\"fa fa-plus fa-fw\"></i></a>";
            }}} ?>
          </p>
        </td>
      </tr>
