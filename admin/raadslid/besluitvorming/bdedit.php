  ...
  <form class="form-horizontal" action="formactions.php" method="POST">
      ...
      <div class="col-md-12 col-xs-12 ">
        <div class="page-header">
          ...
          <div class="pull-right">
            ...
            <button class="btn btn-list btn-primary" type="submit" name ="BVOpinionedit" value="aanpassen">aanpassen</button>
          </div>
              ...
              <div class="col-md-12 col-xs-12 ">
                <div class="form-group <?php if($_SESSION['Callback'] == true){echo "has-error";}?>">
                  ...
                  <div class="col-sm-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="BVPaddVote" id="optionsRadios1" value="1" <?php if($db_getBVOpinionItem_info['vote'] == '1'){echo 'checked';}?>>
                        Voor
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="BVPaddVote" id="optionsRadios2" value="2" <?php if($db_getBVOpinionItem_info['vote'] == '2'){echo 'checked';}?>>
                        Neutraal
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="BVPaddVote" id="optionsRadios3" value="3" <?php if($db_getBVOpinionItem_info['vote'] == '3'){echo 'checked';}?>>
                        Tegen
                      </label>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12 ">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="BVPaddOpinion" rows="2"><?php echo $db_getBVOpinionItem_info['opinion']; ?></textarea>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
        ...
        <button class="btn btn-lg btn-primary text-right" type="submit" name="BVOpinionedit" value="aanpassen">aanpassen</button>
      </div>
    </div>
