  ...
  <form class="form-horizontal" action="formactions.php" method="POST">
      ...
      <div class="col-md-12 col-xs-12 ">
        <div class="page-header">
          ...
          <div class="pull-right">
            ...
            <button class="btn btn-list btn-primary" type="submit" name ="agendaEdit" value="aanpassen">aanpassen</button>
          </div>
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12 ">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="agendaTitle" class="form-control" placeholder="Titel voor agendadatum" value="<?php echo $db_getBVItem_info['title']; ?>">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12 col-xs-12 ">
                <div class="form-group">
                  ...
                  <div class="col-sm-10 date">
                    <input type="text" name="agendaDate" class="form-control input-group-addon-text" placeholder="dd-mm-jjjj" value="<?php echo $db_getBVItem_info['date']; ?>">
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
        ...
        <button class="btn btn-lg btn-primary text-right" type="submit" name="agendaEdit" value="aanpassen">aanpassen</button>
      </div>
    </div>
