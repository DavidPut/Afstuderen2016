      ...
      <tr>
        ...
        <td>
          <p class='text-right'>";
            ...
            echo "<a class=\"btn btn-danger ".(($action == 'delete')?"'btn-disabled'":'')." \" data-toggle=\"tooltip\" data-placement=\"top\" title='Verwijderen' href=\"besluitvorming/delete/\"><i class=\"fa fa-trash-o fa-fw\"></i></a>";
          echo "</p>
        </td>
      </tr>";} ?>
  </tbody>
