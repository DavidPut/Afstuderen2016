  ...
  <?php for ($x = 0; $x <= 5; $x++) {
    echo " 
      <tr>
        ...
        <td>
          <p class='text-right'>
            ".(($action == 'delete')?"<a class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Aanpassen\" href=\"griffie/edit/".$db_getList_info_item['id']."\"><i class=\"fa fa-pencil fa-fw\"></i></a>":""."
