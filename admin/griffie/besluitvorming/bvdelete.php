  ...
  <form class="form-horizontal" action="formactions.php" method="POST">
      ...
      <div class="col-md-12 col-xs-12 ">
        <div class="page-header">
          ...
          <div class="pull-right">
            ...
            <button class="btn btn-list btn-primary" type="submit" name ="BVdelete" value="verwijderen">verwijderen</button>
          </div>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-xs-12">
        ...
        <button class="btn btn-lg btn-danger text-right" type="submit" name="BVdelete" value="verwijderen">verwijderen</button>
      </div>
    </div>
