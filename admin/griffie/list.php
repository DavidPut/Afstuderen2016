<div class="row">
  <div class="col-md-12 col-md-offset-0 col-xs-12 ">
    ...
    <table class="table table-hover table-list">
      ...
      echo "
      <tr>
        <td>" . $db_getList_info_item . "</td>
        <td>Een titel van een besluitvorming</td>
        <td>
          <p class='text-right'>
            <a class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title='Ga naar pagina' href=\"dossier.html\"><i class=\"fa fa-long-arrow-right fa-fw\"></i></a>
