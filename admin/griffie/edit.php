    ...
    <div class="col-md-12 col-xs-12 ">
      <div class="page-header">
        ...
        <div class="pull-right">
          <button data-toggle="tooltip" data-placement="top" title="Besluitvormingsproces toevoegen" class="btn btn-list btn-success"><i class="fa fa-plus small-icon" aria-hidden="true"><a href="griffie/add"></a></i></button>
        </div>
