    ...
    for ($x = 0; $x <= 20; $x++) {
      ...
      <tr>
        ...
        <td>
          ...
          <a href='http://gemeentedossier.nl/griffie.php?action=delete' data-toggle=\"tooltip\" data-placement=\"top\" title='Verwijderen'><button type=\"button\" class=\"btn btn-list btn-danger\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></button></a>
        </td>
      </tr>";
    }
    } else {
